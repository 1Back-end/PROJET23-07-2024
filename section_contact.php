    ...
    <div class="row">
        <div class="col-md-6 col-sm-12 mb-3">
            <div class="mb-3 p-5 h-100 card-box contact-info">
                ...
                <div class="mb-5 align-items-center">
                    <p><span class="icon-bg"><i class="fa fa-phone-square" aria-hidden="true"></i></span> +237 690128711</p>
                </div>
                <div class="mb-5 align-items-center">
                    <p><span class="icon-bg"><i class="fa fa-clock" aria-hidden="true"></i></span> Lun-Ven: 7h30-17h; Sam: 8h-13h</p>
                </div>
            </div>
        </div>
