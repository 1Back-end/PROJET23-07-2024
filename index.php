...
<div class="container section-padding p-3 mt-5">
        ...
        <div class="row">
            ...
            <!-- Deuxième section -->
            <div class="col-md-4 col-sm-12 mb-4">
                <div class="card p-3 h-100 text-center animate__animated animate__fadeInUp animate__delay-1s">
                    <div class="mb-3">
            ...
            <!-- Troisième section -->
            <div class="col-md-4 col-sm-12 mb-4">
                <div class="card p-3 h-100 text-center animate__animated animate__fadeInUp animate__delay-2s">
                    <div class="mb-3">
